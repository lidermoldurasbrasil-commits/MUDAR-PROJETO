...
### Base URL:
```
https://production-tracker-27.preview.emergentagent.com
```
...
**Teste agora:**
```bash
curl -X GET "https://production-tracker-27.preview.emergentagent.com/api/integrator/status" \
...
**Teste agora:**
```bash
curl -X GET "https://production-tracker-27.preview.emergentagent.com/api/integrator/mercadolivre/authorize" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
**Teste:**
```bash
curl -X POST "https://production-tracker-27.preview.emergentagent.com/api/integrator/mercadolivre/sync" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI" \
...
**Teste:**
```bash
curl -X GET "https://production-tracker-27.preview.emergentagent.com/api/integrator/orders?limit=10" \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
5. Configure **Redirect URI**: 
   ```
   https://production-tracker-27.preview.emergentagent.com/api/integrator/mercadolivre/callback
   ```
...
ML_REDIRECT_URI=https://production-tracker-27.preview.emergentagent.com/api/integrator/mercadolivre/callback
...
```bash
# Login como diretor
curl -X POST "https://production-tracker-27.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
...
```bash
# 1. Login
TOKEN=$(curl -s -X POST "https://production-tracker-27.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
