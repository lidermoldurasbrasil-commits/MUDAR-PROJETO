...
class ProductionLoginTester:
    def __init__(self, base_url="https://production-tracker-27.preview.emergentagent.com"):
...
def main():
    ...
    print("🌐 Testing against: https://production-tracker-27.preview.emergentagent.com")
